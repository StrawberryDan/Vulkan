...
function(add_target_shader TARGET SOURCE)
    ...
    set(SHADER_COMPILE_OPTIONS "-O")
    if (CMAKE_BUILD_TYPE STREQUAL "Debug")
        set(SHADER_COMPILE_OPTIONS "-O0 -g")
    endif()
	...
	add_custom_command(OUTPUT ${SOURCE}.bin
			COMMAND ${Python3_EXECUTABLE} ${GRAPHICS_SOURCE_DIR}/share/compile_shader.py ${Vulkan_GLSLC_EXECUTABLE} "${SHADER_COMPILE_OPTIONS}" ${SOURCE} ${SOURCE}.bin
			DEPENDS ${SOURCE} ${ARGN}
	)
